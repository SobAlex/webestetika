...
@section('content')
    ...
    <div class="pt-8">
        @include('partials.breadcrumbs', [
            'breadcrumbs' => [['title' => 'Контакты', 'url' => null]],
        ])
    </div>
    ...
    {{-- Contact Information --}}
    <section class="section-bg" itemscope itemtype="https://schema.org/Organization">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="space-y-8">
                    <!-- Address -->
                    <div class="flex items-start space-x-4" itemprop="address" itemscope
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Адрес офиса</h3>
                            <p class="text-gray-600 text-lg" itemprop="streetAddress">{{ $contactInfo['address'] }}</p>
                        </div>
                    </div>

                    <!-- Phone -->
                    <div class="flex items-start space-x-4" itemprop="contactPoint" itemscope
                        ...
                        <div>
                            ...
                            <a href="tel:{{ str_replace(' ', '', $contactInfo['phone']) }}"
                                class="text-cyan-600 hover:text-cyan-700 text-lg font-medium" itemprop="telephone">
                                {{ $contactInfo['phone'] }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:{{ $contactInfo['email'] }}"
                                class="text-cyan-600 hover:text-cyan-700 text-lg font-medium" itemprop="email">
                                {{ $contactInfo['email'] }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div itemscope itemtype="https://schema.org/OpeningHoursSpecification">
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Режим работы</h3>
                            <p class="text-gray-600 text-lg" itemprop="description">{{ $contactInfo['working_hours'] }}</p>
                        </div>
                    </div>
                </div>

                <!-- Social Media -->
                @if ($contactInfo['social']['telegram'] || $contactInfo['social']['whatsapp'] || $contactInfo['social']['vk'])
                    <div class="mt-12">
                        ...
                        <div class="flex space-x-4">
                            @if ($contactInfo['social']['telegram'])
                                <a href="{{ $contactInfo['social']['telegram'] }}" target="_blank" rel="noopener noreferrer"
                                    class="bg-blue-500 text-white p-3  hover:bg-blue-600 transition" itemprop="sameAs">
                            ...
                            @if ($contactInfo['social']['whatsapp'])
                                <a href="{{ $contactInfo['social']['whatsapp'] }}" target="_blank" rel="noopener noreferrer"
                                    class="bg-green-500 text-white p-3  hover:bg-green-600 transition" itemprop="sameAs">
                                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                            ...
                            @if ($contactInfo['social']['vk'])
                                <a href="{{ $contactInfo['social']['vk'] }}" target="_blank" rel="noopener noreferrer"
                                    class="bg-blue-600 text-white p-3  hover:bg-blue-700 transition" itemprop="sameAs">
                                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                        <path
        ...
        <div class="bg-gray-100  p-8">
            ...
            <div class="bg-gray-300 h-96  flex items-center justify-center">
                <div class="text-center">
                    ...
                    <p class="text-gray-600 text-lg">Карта будет добавлена позже</p>
                    <p class="text-gray-500 mt-2">{{ $contactInfo['address'] }}</p>
                </div>
            </div>
        </div>
    </section>
